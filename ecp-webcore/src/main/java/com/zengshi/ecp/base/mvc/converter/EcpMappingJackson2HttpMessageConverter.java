...
package com.zengshi.ecp.base.mvc.converter;
 ...
 */
public class EcpMappingJackson2HttpMessageConverter extends AbstractHttpMessageConverter<Object>
	 ...
	 */
	public EcpMappingJackson2HttpMessageConverter() {
...
//		this.objectMapper.configure(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS, false);
		...
		Object nObject=object;
		if(JsonResultThreadLocal.get()){
		    ResponseModel jsonObj=new ResponseModel();
	        jsonObj.setAjaxResult(ResultTypeEnum.SUCCESS);
	        jsonObj.setValues(object);
		...
		try {
			...
			this.objectMapper.writeValue(jsonGenerator, nObject);
		}
