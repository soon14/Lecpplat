 ...
 * 
 */
package com.zengshi.ecp.server.front.context;
...
public class ApplicationContextHolder implements ApplicationContextAware{
	...
	public static <T> T getBean(String name, Class<T> clazz){
		...
		T obj = ApplicationContextHolder.getContext().getBean(name, clazz);
	...
	public static Object getBean(String name){
		Object obj=ApplicationContextHolder.getContext().getBean(name);
		if(null==obj){
	...
	public static <T> List<T> getBeans(Class<T> clazz){
	    Map<String,T> map=ApplicationContextHolder.getContext().getBeansOfType(clazz);
