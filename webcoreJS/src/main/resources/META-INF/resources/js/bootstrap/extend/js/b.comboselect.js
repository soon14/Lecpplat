...
!function ($) {
	...
	bComboSelect.prototype = {
		...
		init : function(e,p){
			...
			}).on('bComboSelect',function(){
				if(p && p.callback && $.isFunction(p.callback)){
					var mainBox = $(this).closest('div.ac_container');
					var text = $('input.ac_input',$(mainBox));
					var value = $('input.ac_hidden',$(mainBox));
